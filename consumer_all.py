...
TIPO_CONSUMER = 'all'  # Tipo del consumer: info, warning, error, all, app
QUEUE = 'consumer_all'          # Nombre de la cola
...
# print(f"[*] Consumer '{{TIPO_CONSUMER}}' escuchando en '{consumer_all}'...")
